...
export default function ContentCalendar() {
    return (
        <section className="relative w-full overflow-hidden bg-white px-[120px] py-[80px] max-[1400px]:px-10 max-[1000px]:px-[22px] max-[768px]:px-4 max-[768px]:py-[18px]" id="social-media">
            <div className="mx-auto flex w-full max-w-[1680px] flex-col items-start justify-between gap-8 min-[900px]:flex-row min-[900px]:gap-[142px] max-[1200px]:gap-10">
                <div className="min-w-0 w-full text-left min-[900px]:w-1/2">
                ...
                <div className="hidden min-w-0 w-full items-center justify-end min-[900px]:flex min-[900px]:w-1/2">
